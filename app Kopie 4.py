...
def check_initial_setup():
    ...
    if current_config_name and current_config_name in settings:
        ...
        # NEU: Bürgschaftserhöhung aus Settings laden
    ...
    with st.form("initial_setup"):
        ...
        with col3:
            buergschaft = st.number_input(
                ...
                min_value=0.0,
                value=0.0,  # GEÄNDERT: Von 13500000.0 auf 0.0
                step=100000.0,
                format="%.2f"
            )
...
def init_session_state():
    ...
    defaults = {
        ...
        # Bürgschaftserhöhung kommt aus Settings, nicht mehr hier
    }
